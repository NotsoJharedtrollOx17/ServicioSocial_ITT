...
Going into detail with each of the supplementary activities: (1) consists on explaining the solicited topics with greater detail in accordance to the solicitor's level, with a prior appointment, (2) is the group extension of (1), (3) is to take leadership during the sessions and to solve the solicited problem sets by the students, (3) is about being professional and to attend the call of duty in the established schedules by the program's supervisor, and the previously scheduled appointments with the students, and finally, (5) and (6) consist on the follow-up of the registered community service hours with the reports that the Instituto Tecnológico de Tijuana requires to effectively fulfill community service, including the writing of this report.
